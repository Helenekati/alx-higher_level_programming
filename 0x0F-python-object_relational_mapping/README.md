...
* `State` class:
    ...
    * class attribute `id` that represents a column of an auto-generated, unique integer, canâ€™t be null and is a primary key
    * class attribute `name` that represents a column of a string with maximum 128 characters and canâ€™t be null
...
Write a script that adds the `State` object â€œLouisianaâ€ to the database `hbtn_0e_6_usa`
...
* `City` class:
    ...
    * class attribute `id` that represents a column of an auto-generated, unique integer, canâ€™t be null and is a primary key
    * class attribute `name` that represents a column of a string of 128 characters and canâ€™t be null
    * class attribute `state_id` that represents a column of an integer, canâ€™t be null and is a foreign key to `states.id`
* You must use the module `SQLAlchemy`
...
Write a script that creates the ``State`` â€œCaliforniaâ€ with the `City` â€œSan Franciscoâ€ from the database `hbtn_0e_100_usa`: (`100-relationship_states_cities.py`)
